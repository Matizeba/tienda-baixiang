...
<body class="bg-food-image bg-cover flex items-center min-h-screen font-sans antialiased">
    ...
    <div x-data="{ activeSlide: 0, slides: ['images/logo.png', 'images/slide2.png', 'images/slide3.jpg'] }"
    ...
    <div class="text-center mb-8">
        <img src="{{ asset('images/logo.png') }}" alt="Logo" class="mx-auto img-fluid" style="max-height: 80px;">
